//para editar un donador unicamente el admin
...
import usarEdicionPerfilDonadores from "../../hooks/usarEdicionPerfilDonadores";
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {mostrarConfirmacion && (
        <ConfirmarModal
          ...
          onConfirm={() => handleActualizarPerfil(navigate, 'donador')}
